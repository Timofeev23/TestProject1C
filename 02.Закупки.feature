...
Функционал: 02. Отражение поступления товаров

Как Менеджер по закупкам я хочу
ввести поступление товароы 
...
Сценарий: 01. Ввод поступления товаров
	...
	* Проверка заполнения
		...
		И таблица "Товары" стала равной:
			...
			| '1' | 'ВА - Товар от Поставщика (Оптовый)' | '12345'   | '100,00' | '10,00'      | '1 000,00' |
			| '2' | 'ВА - Товар от Поставщика (Оптовый)' | '12345'   | '120,00' | '10,00'      | '1 200,00' |
	...
	* Проверка движения
		* Взаиморасчеты
			...
			И таблица "Список" содержит строки по шаблону:
				...
				| 'Поступление товара * от *' | '1'            | 'ВА - Поставщик (Оптовый)' | '2 200,00' |
		* Остатки
			Когда открылось окно 'Поступление товара * от *'
			...
			И таблица "Список" содержит строки по шаблону:
				...
				| 'ВА - Основной' | 'Поступление товара * от *' | '1'            | 'ВА - Товар от Поставщика (Оптовый)' | '10,00'      |
				| 'ВА - Основной' | 'Поступление товара * от *' | '2'            | 'ВА - Товар от Поставщика (Оптовый)' | '10,00'      |
